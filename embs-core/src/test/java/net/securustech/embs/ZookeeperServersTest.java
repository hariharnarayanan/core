...
public class ZookeeperServersTest {
    ...
    public static void setUp() throws Exception {
        ...
        System.setProperty("spring.cloud.zookeeper.connect-string", "ld-midsrvcs12.lab.securustech.net:2181,ld-midsrvcs12.lab.securustech.net:2182");
    ...
    public void shouldRetrieveKafkaServersFromZookeeperServers() throws Exception {
